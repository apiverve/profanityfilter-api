...
// Request contains the parameters for the Profanity Filter API.
//
// Parameters:
...
// ResponseData contains the data returned by the Profanity Filter API.
type ResponseData struct {
	IsProfane bool `json:"isProfane"`
	FilteredText string `json:"filteredText"`
	Mask string `json:"mask"`
	Trimmed bool `json:"trimmed"`
	ProfaneWords int `json:"profaneWords"`
}
