...
```gradle
dependencies {
    implementation 'com.github.apiverve:profanityfilter-api:1.1.14'
}
```
...
```java
import com.apiverve.profanityfilter.ProfanityFilterAPIClient;
import com.apiverve.profanityfilter.APIResponse;
import com.apiverve.profanityfilter.APIException;

// Initialize the client
ProfanityFilterAPIClient client = new ProfanityFilterAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("text", "Today is so damn hot! Why the hell would anyone go outside?");
    parameters.put("mask", "*");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/profanityfilter](https://docs.apiverve.com/ref/profanityfilter)
...
- **Documentation:** [https://docs.apiverve.com/ref/profanityfilter](https://docs.apiverve.com/ref/profanityfilter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/profanityfilter-api/issues)
