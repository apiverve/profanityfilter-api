...
class profanityfilterWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/profanityfilter');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/profanityfilter';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"text":{"type":"string","required":true},"mask":{"type":"string","required":false,"default":"*"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/profanityfilter`);
        }
    }
...
module.exports = profanityfilterWrapper;
